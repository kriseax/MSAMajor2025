...
def print_pay_advice(hours, hourly_wage, annual_wage, tax_amount, annual_wage_minus_tax):
    print(f"\nPay Advice")
    print(f"-------------")
...
def main():
    ...
    while another_calculation:
        ...
        do_again = input("Do you want to run another calculation? (y/n): ")

        #decide where to run the program again or stop
        if do_again.lower() == 'n':
